...
A Windows tool that reads a specified COM port and redirects it to another app
...
You must install .NET Runtime 10 x64 and then just run x64\PortRedirect.exe
or .NET Runtime 10 x86 and then just run x86\PortRedirect.exe
